...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Displays all persons in sorted order.";
     ...
     */
    private static String storageFilePath; // class variable?
    ...
    private static String executeSortAllPersonsInAddressBook() {
        ...
        ArrayList<HashMap<PersonProperty, String>> personsCopy = new ArrayList<>(toBeDisplayed);
        Collections.sort(personsCopy, new Comparator<HashMap<PersonProperty, String>>(){
        	@Override
    ...
    */
     ...
     */
    private static boolean hasDeletePersonFromAddressBook(
    ...
    private static String extractPhoneFromPersonString(String encoded) {
        ...
        if (indexOfPhonePrefix > indexOfEmailPrefix) {
            return removePrefixSign(encoded.substring(indexOfPhonePrefix, 
            		encoded.length()).trim(), PERSON_DATA_PREFIX_PHONE);

        // phone is middle arg, target is from own prefix to next prefix
        } else {
            return removePrefixSign(encoded.substring(indexOfPhonePrefix, 
            		indexOfEmailPrefix).trim(), PERSON_DATA_PREFIX_PHONE);
        }
    }
